...
- [x] Test-sheet gallery (8 pages: widths, separation, textures, water/park
      ideas, street-vs-border styles, intersection/crossing/tram/sidewalk
      detail) — "Test sheets" button, or `npx vite-node scripts/testsheets.ts`.
